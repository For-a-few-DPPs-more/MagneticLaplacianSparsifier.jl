...
![](https://github.com/For-a-few-DPPs-more/MagneticLaplacianSparsifier.jl/blob/main/notebooks/figures/MTSF.gif)
The output is an MTSF with one cycle-rooted tree and several rooted tree (roots are in red).
